...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibHlzdXZvcm92YSIsImEiOiJjazJ2endoZWUwOXpoM29xbGVnc2s5M2NuIn0.09nEgtDR9WBkOuq6c0KgDA';
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (res.data.status = 'success') {
            location.reload(true); // location.replace('/');
          }
